...
public class QuantitiesParser extends Parser {
	...
	public static final int
		RULE_quantity_declare = 0, RULE_prefix_declare = 1, RULE_type = 2, RULE_value = 3, 
		RULE_unit = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"quantity_declare", "prefix_declare", "type", "value", "unit"
		};
	}
	...
	public static class Complx_quantity_declContext extends Quantity_declareContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QuantitiesListener ) ((QuantitiesListener)listener).enterComplx_quantity_decl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QuantitiesListener ) ((QuantitiesListener)listener).exitComplx_quantity_decl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QuantitiesVisitor ) return ((QuantitiesVisitor<? extends T>)visitor).visitComplx_quantity_decl(this);
	...
	public static class Quantity_declContext extends Quantity_declareContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QuantitiesListener ) ((QuantitiesListener)listener).enterQuantity_decl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QuantitiesListener ) ((QuantitiesListener)listener).exitQuantity_decl(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QuantitiesVisitor ) return ((QuantitiesVisitor<? extends T>)visitor).visitQuantity_decl(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Quantity_declareContext quantity_declare() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_quantity_declare);
		int _la;
		try {
			setState(25);
	...
	public static class TypeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof QuantitiesListener ) ((QuantitiesListener)listener).enterType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof QuantitiesListener ) ((QuantitiesListener)listener).exitType(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof QuantitiesVisitor ) return ((QuantitiesVisitor<? extends T>)visitor).visitType(this);
			else return visitor.visitChildren(this);
		}
	}
